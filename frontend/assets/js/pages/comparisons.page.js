...
function renderCards(rows) {
  if (!rows.length) {
    return '<article class="admin-status-row"><div><p>Sem comparativos</p><strong>Os comparativos aparecem quando houver multiplos fornecedores por pedido.</strong></div><span class="app-badge is-muted">INFO</span></article>';
  }
